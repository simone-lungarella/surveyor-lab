<div class="grid md:grid-cols-8 md:mt-32">
    <div class="md:col-span-1 lg:col-span-1"/>
    <div class="text-column font-mono prose md:col-span-7">
        <h3 class="text-amber-300">Hello, world! I'm</h3>
        <h1 class="text-white">Simone Lungarella</h1>
        <h3 class="text-gray-300 uppercase">software engineer</h3>
        <p class="text-gray-400">
            I am a web application specialist, proficient in both design and
