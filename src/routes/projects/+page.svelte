...
<div class="grid grid-cols-8 md:grid-cols-9 gap-4 -mt-20 lg:mt-20 space-y-4">
  ...
  {#each $ProjectStore as project (project.id)}
    ...
    <div class="col-span-8 md-col-span-7 prose font-mono">
      <h2 class="text-white">
        <span class="text-amber-300 font-mono flex-inline md:hidden"
          >0{project.id}.
        </span>
        {project.title}
      </h2>
    ...
    <main
      class="col-span-8 md:col-span-7 grid grid-flow-row place-content-center"
    >
      <div
      ...
      >
        ...
        <div class="prose font-mono">
          ...
          <a class="text-white" href={project.page}
            >More about {project.title}</a
          >
            ...
            {#if project.github}
              <a href={project.github}>
                <svg
                  ...
                  class="feather feather-github text-white hover:scale-110 hover:text-amber-300"
                >
                  <path
            ...
            {#if project.website}
              <a href={project.website}>
                <svg
                  ...
                  stroke-linecap="round"
                  stroke-linejoin="round"
                  class="feather feather-external-link text-white hover:scale-110 hover:text-amber-300"
                >
                  <path
