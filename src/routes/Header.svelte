...
<header class="bg-gray-900">
    <div class="flex justify-end items-center w-full h-20">
            ...
            <ul class="gap-2 hidden md:flex mr-10" aria-label="Navigation">
                ...
                <li>
                    <div class="item">
                        ...
                        <a href="/experience" class="text-white hover:text-amber-300">Experience</a>
                    </div>
                </li>
                <li>
                    <div class="item">
        ...
        <div class="md:hidden absolute">
            {#if !mobileMenuOpen}
            <button class="flex items-center rounded top-0 right-0 text-amber-300" on:click={handleMobileMenuOpen}>
    ...
    <div class="bg-gray-600/75 w-3/4 absolute h-full top-0 right-0 shadow-2xl z-50">
        <div class="flex flex-row-reverse">
            <button class="items-center px-3 py-8 rounded text-amber-300" on:click={handleMobileMenuClose}>
        ...
        <nav>
            <ul class="gap-2 flex mr-10 flex-col p-4" aria-label="Navigation">
                <li>
                    <div class="item">
                        <p class="text-amber-300">01.</p>
                        <a href="/about" class="text-white hover:text-amber-300" on:click={handleMobileMenuClose}>About</a>
                    </div>
                </li>
                <li>
                    <div class="item">
                        <p class="text-amber-300">02.</p>
                        <a href="/experience" class="text-white hover:text-amber-300" on:click={handleMobileMenuClose}>Experience</a>
                    </div>
                </li>
                <li>
                    <div class="item">
